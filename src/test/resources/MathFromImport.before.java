...
public class MathFromImport {
    ...
    int c /* BigInteger */ = Math.min(9, 10);

    int d /* BigInteger */ = Math.abs(Math.abs(98));

    int e /* BigInteger */ = Math.abs(Math.min(90, 10));

    int h /* BigInteger */ = Math.min(Math.max(100, 9), Math.max(1, 2));

    int f /* BigInteger */ = Math.abs(Math.min(Math.max(100, 9), Math.abs(Math.max(1, 2))));

    int k /* BigInteger */ = Math.abs(Math.min(Math.max(a, c), Math.abs(Math.max(c, d))));

    int m /* BigInteger */ = Math.min(Math.min(Math.max(a, c), Math.abs(Math.max(d, f))), k);
